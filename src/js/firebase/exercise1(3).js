...
const uniqueAppName = 'exercise1-page3-' + Date.now();
const app = firebase.initializeApp(firebaseConfig, uniqueAppName);
const database = app.database();

console.log('Firebase initialized for Page 3 with correct regional URL:', firebaseConfig.databaseURL);
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    const nextButton = document.querySelector('a[href="27(3).html"]');
    ...
    if (userInput) {
        ...
        const pageData = {
            page: "26(3)",
            question: "Why do you think I am lonely?",
            input: userInput,
            timestamp: Date.now(),
            completed: true
        };
        ...
        console.log('Exercise 1 Page 3 input saved');
        ...
        // Optional: warn user about empty input
    ...
    window.autoSaveTimer = setTimeout(async () => {
        ...
        try {
            ...
            console.log('Auto-saved input for Page 3');
        } catch (error) {
