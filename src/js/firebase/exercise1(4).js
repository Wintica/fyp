 // Suppress Firebase warnings
    ...
    const uniqueAppName = 'exercise1-page4-' + Date.now();
    const app = firebase.initializeApp(firebaseConfig, uniqueAppName);
    const database = app.database();
    
    console.log(' Firebase initialized for Page 4 with correct regional URL:', firebaseConfig.databaseURL);
    ...
    document.addEventListener('DOMContentLoaded', async function() {
      ...
      const nextButton = document.querySelector('a[href="27(4).html"]');
      ...
      nextButton.addEventListener('click', async function(e) {
        ...
        if (userInput) {
          ...
          try {
            ...
            const pageData = {
              page: "26(4)",
              question: "Why do you think I am Frustrated?",
              input: userInput,
              timestamp: Date.now(),
              completed: true
            };
            ...
            // Mark the entire exercise as complete
            await database.ref(`exercise1/${sessionId}/exerciseComplete`).set({
              completed: true,
              completedAt: Date.now(),
              totalPages: 4
            });
            
            console.log('Exercise 1 Page 4 input saved');
            console.log('Exercise 1 marked as complete!');
          ...
          if (!confirmEmpty) {
            ...
            // Save empty input and mark complete
            try {
              ...
              console.log('Exercise 1 marked as complete (empty input)!');
            } catch (error) {
        ...
        window.autoSaveTimer = setTimeout(async () => {
          ...
          if (userInput) {
            try {
              ...
              console.log('Auto-saved input for Page 4');
            } catch (error) {
