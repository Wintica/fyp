    ...
    const uniqueAppName = 'exercise1-page2-' + Date.now();
    const app = firebase.initializeApp(firebaseConfig, uniqueAppName);
    const database = app.database();
    
    console.log('Firebase initialized for Page 2 with correct regional URL:', firebaseConfig.databaseURL);
    ...
    document.addEventListener('DOMContentLoaded', async function() {
      ...
      const nextButton = document.querySelector('a[href="27(2).html"]');
      ...
      nextButton.addEventListener('click', async function(e) {
        ...
        if (userInput) {
          ...
          try {
            ...
            const pageData = {
              page: "26(2)",
              question: "Why do you think I am Hurt?",
              input: userInput,
              timestamp: Date.now(),
              completed: true
            };
            ...
            console.log('Exercise 1 Page 2 input saved');
        ...
        window.autoSaveTimer = setTimeout(async () => {
          ...
          if (userInput) {
            try {
              ...
              console.log(' Auto-saved input for Page 2');
            } catch (error) {
